          ...
          child: Consumer<MainProvider>(
            builder: (context,value,child) {
              return Column(
                ...
                children: [
                  value.selectedPatient != null && value.viewCalenderToken?calenderTokenWidget(context):
                  Column(
                    children: [
                      Container(
                        decoration: BoxDecoration(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: TableCalendar(
                                    ...
                                    startingDayOfWeek: getStartingDayOfWeek(DateTime.now()),
                      ...
                      !value.selectCalender? Column(
                        children: [
                          ...
                          value.selectedDoctor!=null?patientsWidget(context):SizedBox(),
                                ...
                                return Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ...List.generate(value.filteredDoctors.length, (index) {
                                        final doctor = value.filteredDoctors[index];
                                        final isSelected =
                                            value.selectedDoctorIndex != null &&
                                                value.doctors[value.selectedDoctorIndex!] == doctor;
                                        return GestureDetector(
                                          onTap: () {
                                            final originalIndex = value.doctors.indexOf(doctor);
                                            value.selectDoctorIndex(originalIndex);
                                          },
                                          child: Container(
                                            margin: EdgeInsets.only(
                                              bottom: index == value.filteredDoctors.length - 1
                                                  ? 0
                                                  : 16,
                                            ),
                                            child: Row(
                                              ...
                                              children: [
                                                                ...
                                                                RichText(
                                                                  text: TextSpan(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      const TextSpan(text: ' • '),
                                                                      TextSpan(text: doctor.totalBookings.toString()),
                                                                    ],
                                                                  ),
                                                                ),
                                                                SizedBox(width: 2,),
                                                ...
                                                ElevatedButton(
                                                  onPressed: () {
                                                    value.selectDoctor(value.filteredDoctors[index]);
                                                  },
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                DepartmentRow(
                                  ...
                                  availability: '24/38 Doctors Available',
                                ),
                                const SizedBox(height: 12),
                                DepartmentRow(
                                  icon: "assets/images/orthopedic.png",
                                  iconColor: const Color(0xFFE11D48),
                                  title: 'Orthopedic',
                                  subtitle: 'Floor 2, Wing A',
                                  availability: '24/38 Doctors Available',

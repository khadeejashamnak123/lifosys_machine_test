        ...
        child: Consumer<MainProvider>(
          builder: (context,value,child) {
            ...
            notifyPatient = val;
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          return Flex(
                            ...
                            children: [
                              SizedBox(
                                width: isSmall ? double.infinity : constraints.maxWidth / 3 - 16,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text(
                      ...
                      const SizedBox(height: 20),
                     value.checkInConfirmed? LayoutBuilder(
                        builder: (context, constraints) {
                          bool isSmall = constraints.maxWidth < 600;
                          return Flex(
                            direction: isSmall ? Axis.vertical : Axis.horizontal,
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children:  [
                                    Image.asset("assets/images/payment_confirmIcon.png",scale: 2,),
                                    Text("Check-In Confirmed!",style: TextStyle(color: black),),
                                    Text("Robert Fox has been successfully checked in.",style: TextStyle(color: grey),)
                                  ],
                                ),
                              ),
                            ],
                          ...
                          return Flex(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.only(bottom: isSmall ? 5 : 0, right: isSmall ? 0 : 24),
                                decoration: BoxDecoration(
                                  color: bgGray,
                                  border: Border.all(color: borderGray),
                            ...
                            Container(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  const Icon(Icons.keyboard_arrow_down_outlined,size: 12, color: lightGray)
                                                ],
                                              ),
                                            ),
                      ...
                      :Row(
                       ...
                       children: [
                         ElevatedButton(
                           ...
                           child: Row(
                             children: [
                               Image.asset("assets/images/PrinterIcon.png",scale: 2,),
                               const Text(
                                 'Print Bill',
                                 style: TextStyle(
                                   fontWeight: FontWeight.w600,
